...
| ArrastrarPalabras dominaba la ficha (6 de 17 ejercicios, banco de solo 3 opciones, todo nivel 1) | Se convertía CADA frase sobrante en un ejercicio aparte, sin tope, con solo 2 distractores | Tope de 4 por ficha, banco ampliado a 4-5 opciones, nivel por categoría en vez de fijo |
| 5 de 6 preguntas de opción múltiple salían nivel 3 (distribución 1·8·8 en vez de 5·7·5) | El detector de preguntas "contraejemplo" se disparaba con solo 2-3 categorías por ficha: cualquier pregunta normal cuyos 3 distractores cayeran por azar en la misma categoría se marcaba como contraejemplo (nivel 3) aunque no lo fuera | Además del patrón de categorías, se exige que el propio enunciado tenga el fraseo de contraejemplo ("cuál no pertenece"/"NOT belong") que el prompt le pide usar para ese tipo de pregunta |
